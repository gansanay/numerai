...
#
# NumerAPI class from https://github.com/atreichel/NumerAPI
#
...
if __name__ == '__main__':
    ...
    hsn = NumerAPI('', '')
    hsn_name, hsn_ll, hsn_rk, hsn_earned, dummy = hsn.get_user('hsn')
    jmc_name, jmc_ll, jmc_rk, jmc_earned, dummy = hsn.get_user('jmc')
    rdd_name, rdd_ll, rdd_rk, rdd_earned, dummy = hsn.get_user('rdd')
    print 'HSN: {}\nJMC: {}\nRDD: {}'.format(hsn_rk, jmc_rk, rdd_rk)
